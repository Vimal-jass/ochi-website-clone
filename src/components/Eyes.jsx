...
function Eyes() {
    const [Rotate, setRotate] = useState(0)   //0 here angle agar ham setrotate ki  value inc karnege to usestateki value badegi
            ...
            <div data-scroll data-scroll-speed="-.8" className='relative w-full h-full bg-cover bg-center bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")]'>
                <div className='absolute flex gap-10  top-1/2 left-1/2  -translate-x-[50%] -translate-y-[50%]'>
                    <div className='flex items-center justify-center w-[16vw] h-[16vw] rounded-full bg-zinc-100 '>
                        ...
                        <div style={ {transform:`translate(-50%,  -50%) rotate(${Rotate}deg)`}} className=' line absolute flex gap-10  top-1/2 left-1/2  -translate-x-[50%] -translate-y-[50%] w-full h-10'>
