...
function Footer() {
  return (
    <div className='w-full h-screen p-20 flex font-[Founders_Grotesks]'>
        <div className='w-1/2 h-full  flex justify-between flex-col '>
        <div className="heading">
        <h1 className='text-[8vw] font-semibold leading-none tracking-tight uppercase -m-4' >Eye-</h1>
        <h1 className='text-[8vw] font-semibold leading-none tracking-tight uppercase -m-4' >Opening</h1>
        </div>
        ...
        <div className='w-1/2 '>
        <h1 className='text-[6vw] font-semibold leading-none tracking-tight uppercase -m-4' >Presentations</h1>
        <div className="dets font-['Neue_Montreal'] mt-10">
            <a className='text-xl block font-light ' href="#">Facebook</a>
            <a className='text-xl block font-light ' href="#">Instagram</a>
            <a className='text-xl block font-light ' href="#">Linkedin</a>
        </div>
        </div>
